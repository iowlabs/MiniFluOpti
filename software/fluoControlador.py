...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.pushButton_13.clicked.connect(lambda: self.LEDOff(3))
        self.ui.pushButton_14.clicked.connect(lambda: self.LEDOff(3))
...
"""
    ...
    def LEDset(self,ch):
        ...
        self.led_pwr[ch] = val
        if self.miniFluo._default_modules[ch]['status']:
            self.LEDOn(ch)
